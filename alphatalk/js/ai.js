...
2. 메신저 대화다. 한 줄은 짧게. 장문 연설 금지. 지문·내레이션 금지(대사만).
...
5. 이모지를 쓰지 않는다. 엘리시아는 이모지를 모르는 인물이다.`;
  ...
  const BEATS = {
    ...
    3: { morning: "저녁에 할 말이 있다고 예고한다. 별건 아니라고 하지만 명백히 별거다.",
         night: "나흘 뒤 건국제 무도회에 올해는 경비가 아니라 손님으로 가게 됐다고 털어놓는다. 어떻게 하는 건지 몰라 막막해한다." },
...
5. 지문·내레이션·이모지 금지. 대사만. 스탯 수치를 대사에서 직접 언급하지 마라.`;
  }
